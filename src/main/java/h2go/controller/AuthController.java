...
public class AuthController {
  ...
  public void register(@Valid @RequestBody UserRegistrationRequest userDTO) {
    userService.createUser(userDTO);
  }

  @PostMapping("/register/provider")
  public void registerProvider(@Valid @RequestBody ProviderRegistrationRequest providerDTO) {
